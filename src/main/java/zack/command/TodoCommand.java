...
public class TodoCommand implements Command {
    ...
    /**
     * Creates a TodoCommand with the given user input and UI.
     *
     * @param fullInput The full user input.
     * @param ui        The UI used to format output messages.
     */
    public TodoCommand(String fullInput, Ui ui) {
    ...
    public CommandResult execute(Model model) throws ZackException {
        ...
        return new CommandResult(ui.formatAddTodo(todo, model.size()));
    }
}
